...
%regression. Evaluates current BEST individual ON (user supplied) VALIDATION DATASET
...
%   
%   Remarks on the use of validation ('holdout') data: %%% IMPORTANTE!
...
% EVALSTR = best individual (f(genes))

[~,imin]=min(gp.fitness.values)
evalstr=tree2evalstr(gp.pop{imin},gp)
