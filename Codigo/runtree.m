...
%
%   Additional functionality: %% KNOCKOUT: genes indicados são removidos. 
...
elseif ischar(ind) && strcmpi(ind,'best') % ind = 'valbest'
    % Entra aqui se 'best' e 'valbest' forem os mesmos!
...
elseif ischar(ind) && strcmpi(ind,'valbest') % ind = 'valbest'
    ...
    % Só trocou os return values da posição do best
    %copy "best" return values to a slot in the "current" return values
