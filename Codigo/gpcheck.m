...
% str2func (exemplo): f1 = str2func('f1') ---> f1 = @f1
...
if gp.nodes.const.range(1)>gp.nodes.const.range(2) % range de constantes deve ser simétrico em relação ao 0.
...
if ~gp.nodes.const.use_matlab_format % entrará nesse IF
