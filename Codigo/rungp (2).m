...
% % Melhor_RMSE: RMSE do Melhor indivíduo / geração
% f=figure('name','RMSE do Melhor indivíduo / geração','numbertitle','off','visible','off');
% plot(min(gp.geracoes.rmse),'k');
% ylabel('RMSE');
% xlabel('Gerações');
% title(['RMSE do Melhor indivíduo / geração']);
...
% % Melhor_R2ajustado   : R2ajustado do Melhor indivíduo / geração
% f=figure('name','R2ajustado do Melhor indivíduo / geração','numbertitle','off','visible','off');
% plot(r2ajustado_menoresRMSE,'g');
% hold on;
% plot(max(gp.geracoes.r2ajustado),'r');
% ylabel('R2ajustado');
% xlabel('Gerações');
% title(['R2ajustado do Melhor indivíduo / geração']);
% hold off;
% saveas(f,'Melhor_R2ajustado.png');
% 
% % Melhor_numreg : #reg E #reg_signif do Melhor indivíduo / geração
% f=figure('name','#reg E #reg_signif do Melhor indivíduo / geração','numbertitle','off','visible','off');
% plot(reg_menoresRMSE,'m');
% ylabel('#reg');
% xlabel('Gerações');
% title(['#reg do Melhor indivíduo / geração']);
% saveas(f,'Melhor_numreg.png');
% 
% % Melhor_prop_numreg_signif : prop_numreg_signif do Melhor indivíduo / geração
% f=figure('name','prop_numreg_signif do Melhor indivíduo / geração','numbertitle','off','visible','off');
% plot(reg_menoresRMSE,'m');
% ylabel('#reg');
% xlabel('Gerações');
% title(['#reg do Melhor indivíduo / geração']);
...
% 
% 
% % Média_RMSE      : MÉDIA dos indivíduos / geração
% f=figure('name','RMSE: Média dos indivíduos / geração','numbertitle','off','visible','off');
% plot(mean(gp.geracoes.rmse),'r');
% ylabel('RMSE: Média dos indivíduos');
% xlabel('Gerações');
% title(['RMSE: Média dos indivíduos / geração']);
% saveas(f,'Média_RMSE.png');
% 
% % Média_R2ajustado: MÉDIA dos indivíduos / geração
% f=figure('name','R2ajustado: Média dos indivíduos / geração','numbertitle','off','visible','off');
% plot(mean(gp.geracoes.r2ajustado),'k');
% ylabel('R2ajustado: Média dos indivíduos');
% xlabel('Gerações');
% title(['R2ajustado: Média dos indivíduos / geração']);
% saveas(f,'Média_R2ajustado.png');
% 
% % Média_numreg    : MÉDIA dos indivíduos / geração
% f=figure('name','#Regressores: Média dos indivíduos / geração','numbertitle','off','visible','off');
% plot(mean(gp.geracoes.num_reg),'g');
% ylabel('#Regressores: Média dos indivíduos');
% xlabel('Gerações');
% title(['#Regressores: Média dos indivíduos / geração']);
% saveas(f,'Média_numreg.png');
