...
gp.info.stop_time=datestr(now,0); % marca o fim da GP
...
gp.info=rmfield(gp.info,'div0state'); % tira 'div0state' de gp.info
gp.info=rmfield(gp.info,'log0state'); % tira 'log0state' de gp.info
